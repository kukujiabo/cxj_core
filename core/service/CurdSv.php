...
trait CurdSv {
  ...
  public function queryList($condition, $fields, $order, $page, $pageSize, $or = NULL) {
    ...
    if ($totalCount > 0) {
      ...
      $queryPage = (INT)($page < 1 ? 1 : $page);//($page > $pageNum ? $pageNum : ($page < 1 ? 1 : $page));
  ...
  public function findOne($id, $fields='*') {
    ...
    return $model::findOne($id, $fields);
   ...
   * @return int num
   */
  public function queryCount($condition, $or = NULL) {
